...
<div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="masterModal" tabindex="-1" aria-labelledby="masterModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="masterModalLabel">Add New Master Account</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="material-icons">close</i></button>
            </div>
            <form wire:submit.prevent="addNewMaster">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="ABC89898989" wire:model="TOKEN_REF" class="form-control border border-2 p-2">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea wire:model.lazy="USERPROFILE" class="form-control border border-2 p-2"
                                    placeholder="usermessage%3D0%26address2%3DGrade+1%26warning%3D0%26country" id="floatingTextarea1" rows="3"
                                    cols="50"></textarea>
...
<!-- Master Update Modal -->
<div wire:ignore.self class="modal fade" data-bs-backdrop="static" id="updateMasterModal" tabindex="-1" aria-labelledby="updateMasterModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="updateMasterModalLabel">Update Master Account</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="material-icons">close</i></button>
            </div>
            <form wire:submit.prevent="updateMaster">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label>Password</label>
                                <input type="text" placeholder="********" wire:model="PASSWORD" class="form-control border border-2 p-2" disabled>
                                @error('PASSWORD') <span class="text-danger inputerror">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
...
<!--Master Delete Modal -->
<div wire:ignore.self class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="deleteMasterModal" tabindex="-1" aria-labelledby="deleteMasterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="deleteLocationModalLabel">Delete Master Account</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="material-icons">close</i></button>
            </div>
            <div>
                <div class="modal-body">
                    <h6>Are you sure, you want to delete this master account?</h6>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" wire:click="destroyMaster">Yes! Delete</button>
                </div>
            </div>
        </div>
    </div>
